...
export default function Allproducts() {
  ...
  let filteredProducts = products.filter((p) => {
    // فلترة حسب catgory
    const categoryMatch =
      selectedCategory === "جميع المنتجات" || p.category === selectedCategory;
  ...
  const productsPerPage = 6; //علشان يحسب عددهم بعد اللفلترة
      ...
      <div className="container my-5">
        ...
        <section className="my-5">
          <div className="text-center m-auto">
            <span className=" badge-featured text-white py-2 px-4 rounded-4  border border-1  border-secondary">
              <span className="main-color fa-2x "> • </span> مدونتنا{" "}
            </span>
            <h1 className="my-5 fa-5x w-50 m-auto">
              اكتشف <span className="main-color">مقالاتنا </span>
            </h1>
        ...
        <div className="d-flex justify-content-between">
          ...
          <div className="mb-3">
            <div className="input-group flex-nowrap">
              <input
                ...
                placeholder="اضغط للبحث"
                value={searchTerm}
                onChange={(e) => setSearchTerm(e.target.value)}
                aria-label="بحث"
                aria-describedby="addon-wrapping"
              />
              <span className="input-group-text search" id="addon-wrapping">
          ...
          <div className="all-products-container">
            <div className="categories-bar mb-4 d-flex flex-wrap gap-2">
              {categories.map((cat) => (
                <button
                  key={cat}
                  className={`btn ${
        ...
        {/* view ---------------------------------------*/}
        <div className="view-buttons p-3  d-flex flex-row-reverse">
          <button className="btn btn-outline-warning" onClick={squareview}>
            <i className="fa-solid fa-table-cells"></i>
          </button>
          <button className="btn btn-outline-warning" onClick={fullview}>
        ...
        <div className="row my-5">
          {currentProducts.map((product) => (
            <Productdetails key={product.id} pro={product} view={view} />
          ))}
        </div>
